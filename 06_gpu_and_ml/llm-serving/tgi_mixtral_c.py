...
# see
# https://github.com/modal-labs/modal-examples/pull/542
...
from modal import App, Image, Mount, Secret, Stub, asgi_app, enter, exit, gpu, method
...
class Model:
    ...
    async def generate(self, messages: List[Dict[str, str]], sampling_params: Dict[str, float]):
        ...
        result = await self.client.generate(prompt, **sampling_params)
